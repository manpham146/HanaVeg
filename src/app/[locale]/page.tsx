    ...
    <div className="flex flex-col bg-background">
      ...
      <section className="py-24 container mx-auto px-6 lg:px-24">
         ...
         <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
           ...
           <div className="w-full lg:w-1/2 max-w-md">
              <span className="text-secondary text-[10px] tracking-[0.2em] font-sans font-semibold uppercase mb-4 block">{t('intro.label')}</span>
      ...
      <section className="relative h-[60vh] w-full">
         ...
         <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-white gap-6">
           <p className="text-xs tracking-[0.3em] font-sans uppercase opacity-80">{c('brandName')} {c('brandSub')}</p>
           <h2 className="text-2xl sm:text-4xl md:text-6xl font-serif text-center max-w-3xl leading-tight px-6">{t('service.title')}</h2>
            <div className="w-14 h-14 md:w-20 md:h-20 rounded-full border border-white/50 flex items-center justify-center cursor-pointer hover:bg-white/10 transition-colors backdrop-blur-sm">
        ...
        <div className="container mx-auto px-6 lg:px-24 grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
          {(['fresh', 'chef', 'quality'] as const).map((key, idx) => (
            <div key={key} className="flex flex-col items-center px-4">
              <div className="w-32 h-32 mb-8 rounded-full overflow-hidden relative ring-4 ring-secondary/20">
                <Image
      ...
      <section className="py-24">
        <div className="container mx-auto px-6 lg:px-24 flex flex-col lg:flex-row items-center gap-16">
          <div className="w-full lg:w-1/2 relative flex justify-center">
             ...
             <div className="absolute bottom-4 right-8 w-28 h-28 bg-secondary rounded-full flex items-center justify-center text-white text-[9px] tracking-[0.1em] font-sans text-center px-4 leading-snug shadow-xl border-4 border-background z-10">
               {t('menu.badge')}
             </div>
          </div>
          <div className="w-full lg:w-1/2">
             <span className="text-secondary text-[10px] tracking-[0.2em] font-sans font-semibold uppercase mb-4 block">{t('menu.label')}</span>
      ...
      <section className="py-24 bg-surface">
        <div className="container mx-auto px-6 lg:px-24 flex flex-col lg:flex-row items-center gap-16">
           <div className="w-full lg:w-1/2 max-w-md">
              ...
              <div className="text-3xl font-serif text-secondary italic">{t('service.signature')}</div>
           </div>
      ...
      {/* 8. Testimonial */}
      <section className="py-16 md:py-32 container mx-auto px-6 lg:px-24 text-center">
         <div className="text-secondary mb-4 md:mb-6 text-4xl md:text-6xl font-serif leading-none">&ldquo;</div>
         <p className="text-lg md:text-2xl font-serif text-foreground max-w-3xl mx-auto leading-relaxed mb-6 md:mb-8">
           {t('testimonials.quote')}
         </p>
         <div className="text-[10px] tracking-[0.25em] font-sans font-semibold uppercase text-secondary flex items-center justify-center gap-4">
           <span className="w-12 h-[1px] bg-secondary/40 inline-block" />
      ...
      <section className="py-16 border-t border-b border-foreground/5 bg-surface">
