...
**Khách hàng mục tiêu:** Những thực khách tìm kiếm trải nghiệm ẩm thực chay yên bình, hòa mình vào thiên nhiên.
...
## 3. GIAO DIỆN/TRẢI NGHIỆM (UI/UX) & HỆ THỐNG THIẾT KẾ (CHỦ ĐỀ THIỀN & THIÊN NHIÊN)

- **Cảm giác (Vibe):** Bình yên, không gian sân vườn mở, tối giản, sạch sẽ.
- **Bảng màu (Đề xuất):**
...
1. **Trang chủ:** Khu vực Hero với hình ảnh không gian mở/sân vườn chất lượng cao, giới thiệu triết lý ẩm thực chay thiền, các món ăn nổi bật và một nút CTA "Đặt bàn" thu hút.
