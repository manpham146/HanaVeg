...
- **Version 2.0:** Nâng cấp hệ thống đặt bàn hoàn chỉnh (chọn bàn, time slots, admin xác nhận, lịch, thông báo). Hiện tại v1.0 chỉ có form gửi yêu cầu cơ bản.
- **Version 3.0:** Trang Blog đầy đủ (CMS quản lý bài viết, danh sách, chi tiết). Hiện tại v1.0 chỉ có trang "Coming Soon".
- **Version 4.0:** Đặt món trực tuyến (Order Online, giỏ hàng, tracking đơn) và thanh toán online.
- Đặt đồ ăn giao tận nơi (Delivery) và theo dõi shipper.
- Hệ thống thông báo theo thời gian thực (Real-time notifications) cho yêu cầu đặt hàng/đặt bàn.
